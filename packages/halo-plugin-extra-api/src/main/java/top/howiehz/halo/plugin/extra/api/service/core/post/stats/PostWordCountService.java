...
public interface PostWordCountService {
     ...
     * 获取所有文章的总字数。
     *
     * @param isDraft whether to count draft content (true) or release content (false) /
     * 是否统计草稿内容（true）或发布内容（false）
     ...
     *
     * @param postName the name of the post / 文章名称
     * @param isDraft whether to refresh draft cache (true) or release cache (false) /
     * 是否刷新草稿缓存（true）或发布缓存（false）
     ...
     * 刷新所有文章的字数缓存并更新总数。
     *
     * @param isDraft whether to refresh draft caches (true) or release caches (false) /
     * 是否刷新草稿缓存（true）或发布缓存（false）
     ...
     * 通过重新计算缓存的文章数据来刷新总字数。
     *
     * @param isDraft whether to refresh draft total (true) or release total (false) /
     * 是否刷新草稿总数（true）或发布总数（false）
