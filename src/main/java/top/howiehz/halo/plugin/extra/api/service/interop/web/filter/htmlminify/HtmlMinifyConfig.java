...
public class HtmlMinifyConfig {
     ...
     * 是否启用 HTML 页面压缩。
     */
    private boolean enabledHtmlMinify = false;
     ...
     * 是否允许非规范的无引号属性值。
     */
    private boolean allowNoncompliantUnquotedAttributeValues = false;

    /**
     * Allow more aggressive entity optimizations.
     * 是否允许更激进的实体优化。
     */
    private boolean allowOptimalEntities = false;

    /**
     * Allow removing spaces between attributes when possible.
     * 是否允许在可能时移除属性之间的空格。
     */
    private boolean allowRemovingSpacesBetweenAttributes = false;

    /**
     * Keep optional closing tags.
     * 是否保留可省略的闭合标签。
     */
    private boolean keepClosingTags = true;
     ...
     */
    private boolean keepHtmlAndHeadOpeningTags = true;

    /**
     * Keep type=text on input elements.
     * 是否保留 input 元素的 type=text 属性。
     */
    private boolean keepInputTypeTextAttr = true;

    /**
     * Keep SSI comments.
     * 是否保留 SSI 注释。
     */
    private boolean keepSsiComments = true;
     ...
     * 是否压缩 DOCTYPE 声明。
     */
    private boolean minifyDoctype = false;
     ...
     * 是否保留花括号模板语法。
     */
    private boolean preserveBraceTemplateSyntax = true;

    /**
     * Preserve <% %> template syntax.
     * 是否保留 <%%> 模板语法。
     */
    private boolean preserveChevronPercentTemplateSyntax = true;

    /**
     * Remove bangs.
     * 是否移除 bang 声明。
     */
    private boolean removeBangs = true;

    /**
     * Remove processing instructions.
     * 是否移除处理指令。
     */
    private boolean removeProcessingInstructions = true;
}
