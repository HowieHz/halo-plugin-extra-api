package top.howiehz.halo.plugin.extra.api.service.core.post.stats;
...
public interface PostStatsDataCacheManager {
     ...
     * 获取缓存的所有文章总字数。
     *
     * @param isDraft whether to get draft total (true) or release total (false) /
     * 是否获取草稿总数（true）或发布总数（false）
     ...
     * @param isDraft whether to get draft count (true) or release count (false) /
     * 是否获取草稿字数（true）或发布字数（false）
     ...
     * @param isDraft whether this is draft total (true) or release total (false) /
     * 是否为草稿总数（true）或发布总数（false）
     */
     ...
     * @param isDraft whether this is draft count (true) or release count (false) /
     * 是否为草稿字数（true）或发布字数（false）
     */
     ...
     * 清除总字数缓存。
     *
     * @param isDraft whether to clear draft total cache (true) or release total cache (false) /
     * 是否清除草稿总数缓存（true）或发布总数缓存（false）
     */
     ...
     *
     * @param postName the name of the post / 文章名称
     * @param isDraft whether to clear draft cache (true) or release cache (false) /
     * 是否清除草稿缓存（true）或发布缓存（false）
     */
